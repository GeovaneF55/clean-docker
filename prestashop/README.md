...
Then reach your shop on this URL: http://localhost:8000

Docker will bind your port 8000 to the web server. If you want to use other port, open and modify the file `docker-compose.yml`.
